...
*Created by Actel MSS_ACE Configurator Sun Dec 09 18:13:40 2012
*
*/
...
{
	{
        16,                        /* uint16_t    m_ppe_offset */
        17,                        /* uint16_t    c_ppe_offset */
